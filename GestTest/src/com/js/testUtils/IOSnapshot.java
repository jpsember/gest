...
public class IOSnapshot {
	...
	private void prepareDynamicSnapshotsDir() {
		final String helpfulMessage = ";\n does manifest have WRITE_EXTERNAL_STORAGE permission enabled?";

		if (mDynamicSnapshotsDir == null) {
			File directory = Environment.getExternalStorageDirectory();
			if (directory == null)
				die("external files dir is null" + helpfulMessage);
			...
			if (!mDynamicSnapshotsDir.exists())
				die("unable to create " + mDynamicSnapshotsDir + helpfulMessage);
		}
	}
